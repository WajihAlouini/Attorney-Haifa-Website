...
export const fr: Translation = {
  ...
  // Frozen snapshot of real Google reviews — shown only if the live
  // google-reviews.json fails to load. Never invent testimonials here.
  reviews: [
    {
      rating: "★★★★★",
  ...
  cookieCompact: "Nous utilisons des cookies pour améliorer votre expérience.",
