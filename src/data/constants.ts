...
// General prefilled WhatsApp message per locale — deliberately case-agnostic
// so it fits any visitor, while still telling the firm the contact came
// from the website.
export const whatsappPrefill: Record<"fr" | "en" | "ar", string> = {
  fr: "Bonjour Maître, je vous contacte depuis votre site pour une consultation juridique.",
  en: "Hello, I'm contacting you from your website to request a legal consultation.",
  ar: "مرحبا أستاذة، أراسلكم من موقعكم لطلب استشارة قانونية.",
};
